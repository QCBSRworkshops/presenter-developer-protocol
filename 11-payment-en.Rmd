...
![](https://img.shields.io/badge/ATTENTION-Award%20request%20procedure%20changed%20on%2029--04--2022-red?style=for-the-badge)
...
1.  **First, complete the [presenter payment sheet](https://docs.google.com/spreadsheets/d/14JV8INe4CNO_BsaranuQto6qtjXb-MMO/edit?usp=sharing) and/or the [developer payment sheet](https://docs.google.com/spreadsheets/d/1leXhiq54pGBRdaQE58nr0HD22j5DAYSP/edit?usp=sharing) by filling in the requested information.**

    -   Report each workshop on a separate line if you contributed to multiple workshops.

    -   For presenters: You can refer to the [compensation standards](#preparation-en) section within this protocol to know the budget allocated to your workshop. *Remember that each presenter receives a maximum award of \$180 per workshop instructed*.
...
3.  **Third, send the invoice to [csbq.qcbs.r\@gmail.com](mailto:csbq.qcbs.r@gmail.com) (QCBS R Workshop Series Coordinators)**.
...
4.  **Fourth, QCBS and/or McGill administrative associates will message you with a Student Stipend Payment Authorization Form which you need to sign.**
...
2.  **Second, register as a Payee by completing and signing this [form](https://github.com/QCBSRworkshops/presenter-developer-protocol/blob/master/employee_or_selfemployed.pdf?raw=true) and this e-payment [form](https://github.com/QCBSRworkshops/presenter-developer-protocol/blob/master/epayment_form_v1.0_-_20201029_fillable.pdf?raw=true)**.

    -   You only need to do this once, if you have previously registered as a Payee then you can move on to Step 3.

    -   Save these files as "`YOURLASTNAME_PayeeForm.pdf`" and "`YOURLASTNAME_EPaymentForm.pdf`".
...
4.  **Fourth, send the payment forms, void cheque, and invoice to [csbq.qcbs.r\@gmail.com](mailto:csbq.qcbs.r@gmail.com) (which is managed by the R Workshop Series coordinators)**.
...
5.  **Fifth, after a few weeks McGill University's Procurement Services will send the QCBS administrative personnel an e-mail containing a purchase order, with you in CC.**

    -   The QCBS administrative personnel will fill in this purchase order for you, and submit it to Accounts Payable ([accountspayable\@mcgill.ca](mailto:accountspayable@mcgill.ca)) at McGill University.
