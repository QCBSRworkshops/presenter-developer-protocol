...
*Remote workshops* should run for approximately 3 hours. This time will be broken into two 1.5 hour sections, with a 1 hour break in middle. Workshops have been shortened to suit this new format.

During both remote and in-person workshop contexts, breaks of 5 to 10 minutes (each) should be provided to allow participants and presenters to take a short pause and to address any outstanding questions.
...
6. Stimulate collaboration whenever possible. Students engaged in a directed, social learning
