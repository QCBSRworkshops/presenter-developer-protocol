...
Following the welcome and check-in block, workshop presenters should being their lecture blocks by illustrating and specifying the content of the workshop and how the lecture and pause blocks will be structured.
...
9. Whenever asking questions to participants, it is a good practice to not only request responses from volunteers, but to "point" or "name" someone to respond to your question.
...
5. Take attendance, and reach out to non-registered participants to request them to immediately register to the workshop.
