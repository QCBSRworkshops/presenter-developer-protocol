...
* **For workshops held on Zoom:** We require at least two presenters per workshop; one presenter will give the presentation and answer student questions, and the other presenter will act as an assistant, monitoring the chat, setting up break out rooms and also answering student questions. (These tasks can be split in a different way. Co-presenters can work that amongst yourselves). 
...
4. For *remote workshops*: Fammiliarize yourself with Zoom *add more here*
