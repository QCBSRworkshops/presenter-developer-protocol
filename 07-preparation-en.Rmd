...
* **For remote workshops:** We require at least two presenters per workshop on Zoom; one presenter will present the content, and the other presenter will act as an assistant, monitoring the chat, setting up break out rooms. Both will answer student questions. (If preferred, co-presentors can decide to split these tasks in a different way amongst themselves). 
...
4. **For remote workshops**: Familiarize yourself with Zoom before you workshop. For example, you should know; how to share you scrren; how to inititate and end break out rooms; and what tools are available for interacting with students. *add a link to a resource here?*
...
1. Arrive *at least* 15 minutes before the beginning of your workshop to prepare the presentation room and project your presentation. For remote workshops, open the meeting room early and check-in with your co-presenter before students arrive;
2. Take attendance;
...
4. Start your presentation **on time**:
  ...
  * Reassure attendants that they can raise their hands and pose questions to you during the workshop. If the workshop is remote, make sure students understand how to use the chat and raise their hand in Zoom;
  * Do a quick survey of your students to see how much experience they have with the workshop topic. This can inform your delivery speed, and the amount of time you set aside to work through exercises. 
  * Check in regularly with your students. Are they following along? If not, you may need to repeat information more than once before moving forward.
