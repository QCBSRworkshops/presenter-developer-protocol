...
2.  **Remplissez et signez ce [formulaire](https://github.com/QCBSRworkshops/presenter-developer-protocol/blob/master/employee_or_selfemployed.pdf?raw=true)** **et ce [formulaire](https://github.com/QCBSRworkshops/presenter-developer-protocol/blob/master/epayment_form_v1.0_-_20201029_fillable.pdf?raw=true) de paiement électronique.**
    ...
    -   Enregistrez ce fichier sous le nom de "`VOTRENOM_PayeeForm.pdf`" et "`VOTRENOM_EPaymentForm.pdf`".

    -   Téléchargez et enregistrez un spécimen de chèque du compte bancaire sur lequel vous souhaitez recevoir l'argent.
...
4.  **Envoyez les formulaires, le spécimen de chèque et la facture à [csbq.qcbs.r\@gmail.com](mailto:csbq.qcbs.r@gmail.com) (Équipe de coordination de la série d'ateliers R du CSBQ)**.
