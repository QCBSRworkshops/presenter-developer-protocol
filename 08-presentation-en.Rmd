...
Entering presenter mode, allows you to view presentation notes while giving your instruction. To enter presenter mode, use the keyboard shortcut `P`.

## Zoom guidelines {#zoom-guidelines}

Running a workshop through Zoom might not be within every presenter's comfort zone. Here are some guidelines to help with the process of using Zoom to create a (hopefully!) technically smooth and interactive workshop experience.
